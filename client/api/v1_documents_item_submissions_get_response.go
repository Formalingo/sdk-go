...
// NewV1DocumentsItemSubmissionsGetResponse instantiates a new V1DocumentsItemSubmissionsGetResponse and sets the default values.
func NewV1DocumentsItemSubmissionsGetResponse()(*V1DocumentsItemSubmissionsGetResponse) {
    m := &V1DocumentsItemSubmissionsGetResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1DocumentsItemSubmissionsGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1DocumentsItemSubmissionsGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1DocumentsItemSubmissionsGetResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1DocumentsItemSubmissionsGetResponse) GetAdditionalData()(map[string]any) {
...
func (m *V1DocumentsItemSubmissionsGetResponse) GetSuccess()(*bool) {
    return m.success
}
// Serialize serializes information the current object
func (m *V1DocumentsItemSubmissionsGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetData() != nil {
...
func (m *V1DocumentsItemSubmissionsGetResponse) SetAdditionalData(value map[string]any)() {
...
func (m *V1DocumentsItemSubmissionsGetResponse) SetSuccess(value *bool)() {
    m.success = value
}
