...
type V1DocumentsItemSubmissionsItemWithS404Error struct {
...
// NewV1DocumentsItemSubmissionsItemWithS404Error instantiates a new V1DocumentsItemSubmissionsItemWithS404Error and sets the default values.
func NewV1DocumentsItemSubmissionsItemWithS404Error()(*V1DocumentsItemSubmissionsItemWithS404Error) {
    m := &V1DocumentsItemSubmissionsItemWithS404Error{
        ApiError: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewApiError(),
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1DocumentsItemSubmissionsItemWithS404ErrorFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1DocumentsItemSubmissionsItemWithS404ErrorFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1DocumentsItemSubmissionsItemWithS404Error(), nil
}
// Error the primary error message.
// returns a string when successful
func (m *V1DocumentsItemSubmissionsItemWithS404Error) Error()(string) {
...
// returns a *string when successful
func (m *V1DocumentsItemSubmissionsItemWithS404Error) GetHint()(*string) {
    return m.hint
}
// GetSuccess gets the success property value. The success property
// returns a *bool when successful
func (m *V1DocumentsItemSubmissionsItemWithS404Error) GetSuccess()(*bool) {
    return m.success
}
...
func (m *V1DocumentsItemSubmissionsItemWithS404Error) SetHint(value *string)() {
    m.hint = value
}
// SetSuccess sets the success property value. The success property
func (m *V1DocumentsItemSubmissionsItemWithS404Error) SetSuccess(value *bool)() {
    m.success = value
}
