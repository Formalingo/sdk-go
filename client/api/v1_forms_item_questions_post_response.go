...
// NewV1FormsItemQuestionsPostResponse instantiates a new V1FormsItemQuestionsPostResponse and sets the default values.
func NewV1FormsItemQuestionsPostResponse()(*V1FormsItemQuestionsPostResponse) {
    m := &V1FormsItemQuestionsPostResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1FormsItemQuestionsPostResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1FormsItemQuestionsPostResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1FormsItemQuestionsPostResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1FormsItemQuestionsPostResponse) GetAdditionalData()(map[string]any) {
...
func (m *V1FormsItemQuestionsPostResponse) GetSuccess()(*bool) {
    return m.success
}
// Serialize serializes information the current object
func (m *V1FormsItemQuestionsPostResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1FormsItemQuestionsPostResponse) SetAdditionalData(value map[string]any)() {
...
func (m *V1FormsItemQuestionsPostResponse) SetSuccess(value *bool)() {
    m.success = value
}
