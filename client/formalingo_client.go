...
import (
    ...
    icec251163f3e2b895422100ad8b7c59aa7edc1ecc6531fcd3b302c8a68c21875 "github.com/Formalingo/sdk-go/client/api"
)

// FormalingoClient the main entry point of the SDK, exposes the configuration and the fluent API.
type FormalingoClient struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// Api the api property
// returns a *ApiRequestBuilder when successful
func (m *FormalingoClient) Api()(*icec251163f3e2b895422100ad8b7c59aa7edc1ecc6531fcd3b302c8a68c21875.ApiRequestBuilder) {
    return icec251163f3e2b895422100ad8b7c59aa7edc1ecc6531fcd3b302c8a68c21875.NewApiRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// NewFormalingoClient instantiates a new FormalingoClient and sets the default values.
func NewFormalingoClient(requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FormalingoClient) {
    m := &FormalingoClient{
    ...
    if m.BaseRequestBuilder.RequestAdapter.GetBaseUrl() == "" {
        m.BaseRequestBuilder.RequestAdapter.SetBaseUrl("http://localhost:3000")
    }
